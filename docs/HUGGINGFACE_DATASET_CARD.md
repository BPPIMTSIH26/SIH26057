...
# S.A.G.A.R. — Side-Scan Sonar Training Splits
...
| :--- | :--- | :--- |
| pipe, bg | [SubPipe / SubPipeMini2](https://github.com/IRVLab/SubPipe) — Álvarez-Tuñón et al., OceanScan-MST | CC-BY-4.0 |
| wreckA | [AI4Shipwrecks](https://github.com/rrawfishh/AI4Shipwrecks) — Sethuraman et al., UM Field Robotics / NOAA Thunder Bay | CC-BY-4.0 |
| wreckR | [Side Scan Sonar (Ship, Plane)](https://universe.roboflow.com/dae-hyeok-lee/side-scan-sonar-ship-plane) — Dae Hyeok Lee, Roboflow Universe | CC-BY-4.0 |
| mine | [Sonar Imaging Mine Detection](https://www.kaggle.com/datasets/milco-contacts/sonar-imaging-mine-detection) — MILCO contacts | CC-BY-SA-4.0 |
...
- **`crab_pot`** (class id 0) — 1,200 tiles were used to train the shipped model as a hard negative, from a HuggingFace set that is now access-gated. They are **omitted here**. Class 0 therefore has zero examples in this repo.
...
sagar.yaml            # Ultralytics data config
```
...
```bibtex
@software{sagar2026,
  title  = {S.A.G.A.R.: AI-Powered Marine Debris Detection from Side-Scan Sonar},
  author = {Narayan Kumar Jha and others},
  year   = {2026},
  note   = {Smart India Hackathon 2026, Problem Statement 26057},
  url    = {https://github.com/BPPIMTSIH26/SIH26057}
}
```
